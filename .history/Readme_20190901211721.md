...
|----------------------------------------------|:-----------------------------------:|-----------------------------:|       
|Page loads	 and has active nav bars                          |   User enters information in a form                            |       alert message is shown  |                        |
...
* Javascript - For form validation and logic, toggling effect on images, pa
